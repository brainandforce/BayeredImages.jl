...
Represents an raw image from a camera with a color filter array with attached CFA data.
"""
...
Base.@propagate_inbounds Base.getindex(ci::CFAImage, i...) = getindex(ci.image, i...)
